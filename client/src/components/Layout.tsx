        ...
        <div className='container mx-auto px-4'>
          <div className='flex items-center justify-between h-16'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <button
                onClick={() => window.open('https://blog.huuvan.dev', '_blank', 'noopener,noreferrer')}
              ...
              >
                ...
                <span className='text-white font-semibold text-lg group-hover:text-yellow-300 transition-colors'>
                  Blog
                </span>
              </button>
            </div>
